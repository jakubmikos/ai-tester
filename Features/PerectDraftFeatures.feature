...
@P2 @UserRegistration @Smoke @Ignore
...
@P1 @UserAuthentication @Smoke @Ignore
...
@P2 @BeerTokens @Regression @Ignore
...
@P2 @KegReturns @Regression @Ignore
...
@P2 @OrderHistory @Regression @Ignore
...
@P2 @EmailNotifications @Regression @Ignore
